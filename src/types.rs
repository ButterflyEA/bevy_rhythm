...
impl Directions {
    ...
    pub fn key_just_pressed(&self, input: &ButtonInput<KeyCode>) -> bool {
        let keys = match self {
            Directions::Up => [KeyCode::ArrowUp, KeyCode::KeyD],
            Directions::Down => [KeyCode::ArrowDown, KeyCode::KeyF],
            Directions::Left => [KeyCode::ArrowLeft, KeyCode::KeyJ],
            Directions::Right => [KeyCode::ArrowRight, KeyCode::KeyK],
        };
